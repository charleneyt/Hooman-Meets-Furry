  ...
  return (
    <div>
      ...
      >
        ...
        <MenuItem value={50} onClick={handleClose} disableRipple>
          50<PetsIcon sx={{ fontSize: 18, marginLeft: "0.5rem" }}/>
        </MenuItem>
        <MenuItem value={100} onClick={handleClose} disableRipple>
          100 <PetsIcon sx={{ fontSize: 18, marginLeft: "0.5rem" }}/>
        </MenuItem>
        <MenuItem value={120} onClick={handleClose} disableRipple>
          120 <PetsIcon sx={{ fontSize: 18, marginLeft: "0.5rem" }}/>
        </MenuItem>
      </StyledMenu>
    </div>
  );
