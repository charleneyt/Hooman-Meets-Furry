...
const catCards = [
  ...
  {name: "Rocky", img: rockyPic, catBtn: "https://img.icons8.com/cotton/30/000000/dog--v1.png"},
  {name: "Tubby", img: tubbyPic, catBtn: "https://img.icons8.com/emoji/30/000000/star-emoji.png"}
...
<section class="text--center">
  <div class="container">
    ...
    <Button variant="contained" size="big" style={{boxShadow: "none", backgroundImage: "linear-gradient(to right, #fbc2eb 0%, #a6c1ee 51%, #fbc2eb 100%)"}}>Sign Up Now</Button>
  </div>
</section></div>;
}
